...
\sideremark{TODO: more about why these two background sections are included}
...
\end{equation}
Denoting $\vect x = \vect x_j$, we can rewrite each $p_{\beta}(\vect x_j)$ as %\sideremark{I don't know the best way to index $p_\beta$ }
\begin{equation}
  \begin{split}
...
%TODO
\sideremark{TODO: Wu et al, Wang et al}
