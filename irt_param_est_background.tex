...
We derive the desired loss function for a VAE. The log marginal likelihood of $N$ observed data points is given as
\begin{equation}
...
The normal ogive model gives the probability of student $j$ answering item $i$ correctly as
\begin{equation}
