...
\begin{frame}{Joint Maximum Likelihood Estimation (JMLE)}
  TODO: clean this up and summarize JMLE in one slide %TODO
\begin{itemize}
...
\begin{frame}{Correlated VAE Implementation}
  TODO: clean up proof %TODO
  \textbf{Theorem}: Let $L_0$ be any lower triangular matrix. Then $\Sigma_0 = e^{L_0}\cdot \left(e^{L_0}\right)^\top$ is symmetric and positive definite.
\begin{proof}
\small
...
\begin{frame}{Package in R}
  TODO: give better explanation of why this is worth mentioning %TODO
\begin{itemize}
